...
public class GetQnADataAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    private static final int TYPE = 1;
    private final Context context;
    private final List<Object> listRecyclerItem;
    public GetQnADataAdapter(Context context, List<Object> listRecyclerItem) {
