...
public class GetQuestionandAnswer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_questionandanswer);
        ...
        mAdapter = new GetQnADataAdapter(this, viewItems);
    ...
    private String readJSONDataFromFile() throws IOException{
        ...
        try {
            ...
            inputStream = getResources().openRawResource(R.raw.questionandanswer);
