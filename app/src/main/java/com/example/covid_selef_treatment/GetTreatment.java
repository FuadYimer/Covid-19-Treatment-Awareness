...
public class GetTreatment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_treatment);
    ...
    private void addItemsFromJSON() {
        try {
            ...
            for (int i=0; i<jsonArray.length(); ++i) {
                ...
                GetQnAData getPreventionData = new GetQnAData(title, detail);
